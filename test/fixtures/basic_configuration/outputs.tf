...
output "collector_vpc_network_id" {
  ...
  value       = module.basic_configuration.collector_vpc_network_id
}
...
output "collector_vpc_subnets_ids" {
  ...
  value       = module.basic_configuration.collector_vpc_subnets_ids
}
...
output "autoscaler_ids" {
  ...
  value       = module.basic_configuration.autoscaler_ids
}
...
output "loadbalancer_ids" {
  ...
  value       = module.basic_configuration.loadbalancer_ids
}
...
output "forwarding_rule_ids" {
  ...
  value       = module.basic_configuration.forwarding_rule_ids
}
...
output "packet_mirroring_policy_ids" {
  ...
  value       = module.basic_configuration.packet_mirroring_policy_ids
}
