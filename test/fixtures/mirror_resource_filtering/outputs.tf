...
output "collector_vpc_network_id" {
  ...
  value       = module.mirror_resource_filtering.collector_vpc_network_id
}
...
output "collector_vpc_subnets_ids" {
  ...
  value       = module.mirror_resource_filtering.collector_vpc_subnets_ids
}
...
output "autoscaler_ids" {
  ...
  value       = module.mirror_resource_filtering.autoscaler_ids
}
...
output "loadbalancer_ids" {
  ...
  value       = module.mirror_resource_filtering.loadbalancer_ids
}
...
output "forwarding_rule_ids" {
  ...
  value       = module.mirror_resource_filtering.forwarding_rule_ids
}
...
output "packet_mirroring_policy_ids" {
  ...
  value       = module.mirror_resource_filtering.packet_mirroring_policy_ids
}